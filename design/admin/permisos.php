      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full overflow-y-auto bg-white">
          <div class="container px-6 mx-auto grid">
            <p class="my-6 text-2xl font-semibold text-gray-700">
              Lista de permisos
            </p>
                    <!-- New Table -->
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full overflow-x-auto">
                    ...
                    $query = "SELECT u.id_user as ID, u.email as correo, r.rol as Permisos, e.estado as Estado from usuarios u 
                    inner join roles r on r.id_rol = u.rol_id
                    inner join estado e on e.id_estado = u.estado";
                    // var_dump($id);
                    ...
                    while ($row = $result->fetch_assoc()){
                      ...
                      echo "<td class='px-4 py-3'>" . $row['correo'] . "</td>";
                      echo "<td class='px-4 py-3'>" . $row['Permisos'] ."</td>";
                      echo "<td class='px-4 py-3'>" . $row['Estado'] . "</td>";
                      echo "<td class='px-4 py-3'>
                              <div class='flex flex-row items-center space-x-4 text-sm'>
                                  <form action='./../admin/permiso_edicion.php' method='POST'>
                                      <input type='number' hidden value='{$row['ID']}' name='id_user'>
