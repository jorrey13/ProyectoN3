      ...
      <div class="flex flex-col flex-1 w-full">
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          ...
          >
            ...
            <h4 class="mb-6 text-lg font-bold text-gray-600 dark:text-gray-300">
              Editar datos de perfil
            </h4>
        <main class="mb-6 h-full font-bold overflow-y-auto bg-white">
          <p>Información del usuario:</p>
          <form class="container px-6 mx-auto grid" action="./../../handle_db/edit_maestro.php" method="post">
